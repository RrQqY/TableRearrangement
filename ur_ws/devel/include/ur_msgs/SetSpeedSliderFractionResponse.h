...
bool operator==(const ::ur_msgs::SetSpeedSliderFractionResponse_<ContainerAllocator1> & lhs, const ::ur_msgs::SetSpeedSliderFractionResponse_<ContainerAllocator2> & rhs)
{
