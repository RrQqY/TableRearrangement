...
void subscribe_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"subscribe\"...");
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 1 (topicName)...");
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 2 (topicType)...");
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 3 (topicCallback)...");
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 4 (queueSize)...");
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: writing output argument 1 (subscriberHandle)...");
#endif // NDEBUG
...
void shutdownSubscriber_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"shutdownSubscriber\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 1 (subscriberHandle)...");
#endif // NDEBUG
...
void subscriberTreatUInt8ArrayAsString_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"subscriberTreatUInt8ArrayAsString\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
void advertise_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"advertise\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 3 (queueSize)...");
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 4 (latch)...");
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: writing output argument 1 (publisherHandle)...");
#endif // NDEBUG
...
void shutdownPublisher_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"shutdownPublisher\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 1 (publisherHandle)...");
#endif // NDEBUG
...
void publisherTreatUInt8ArrayAsString_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"publisherTreatUInt8ArrayAsString\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
void publish_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"publish\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
void serviceClient_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"serviceClient\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 1 (serviceName)...");
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 2 (serviceType)...");
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: writing output argument 1 (serviceClientHandle)...");
#endif // NDEBUG
...
void shutdownServiceClient_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"shutdownServiceClient\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 1 (serviceClientHandle)...");
#endif // NDEBUG
...
void serviceClientTreatUInt8ArrayAsString_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"serviceClientTreatUInt8ArrayAsString\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
void call_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"call\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
void advertiseService_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"advertiseService\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 3 (serviceCallback)...");
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: writing output argument 1 (serviceServerHandle)...");
#endif // NDEBUG
...
void shutdownServiceServer_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"shutdownServiceServer\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 1 (serviceServerHandle)...");
#endif // NDEBUG
...
void serviceServerTreatUInt8ArrayAsString_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"serviceServerTreatUInt8ArrayAsString\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
void sendTransform_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"sendTransform\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
void sendTransforms_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"sendTransforms\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
void imageTransportSubscribe_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"imageTransportSubscribe\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 2 (topicCallback)...");
#endif // NDEBUG
...
void imageTransportShutdownSubscriber_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"imageTransportShutdownSubscriber\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
void imageTransportAdvertise_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"imageTransportAdvertise\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 2 (queueSize)...");
#endif // NDEBUG
...
void imageTransportShutdownPublisher_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"imageTransportShutdownPublisher\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
void imageTransportPublish_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"imageTransportPublish\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 2 (data)...");
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 3 (width)...");
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 4 (height)...");
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 5 (frame_id)...");
#endif // NDEBUG
...
void getTime_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"getTime\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 1 (flag)...");
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: writing output argument 1 (time)...");
#endif // NDEBUG
...
void getParamString_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"getParamString\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 1 (name)...");
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 2 (defaultValue)...");
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: writing output argument 1 (exists)...");
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: writing output argument 2 (value)...");
#endif // NDEBUG
...
void getParamInt_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"getParamInt\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
void getParamDouble_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"getParamDouble\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
void getParamBool_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"getParamBool\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
void setParamString_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"setParamString\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: reading input argument 2 (value)...");
#endif // NDEBUG
...
void setParamInt_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"setParamInt\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
void setParamDouble_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"setParamDouble\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
void setParamBool_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"setParamBool\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
void hasParam_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"hasParam\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
void deleteParam_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"deleteParam\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
void searchParam_callback(SScriptCallBack *p)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback for \"searchParam\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: reading input arguments...");
        simDebugStack(p->stackID, -1);
    }
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: writing output argument 1 (found)...");
#endif // NDEBUG
...
#ifndef NDEBUG
            if(isDebugStubsEnabled())
                log(sim_verbosity_debug, "DEBUG_STUBS: writing output argument 2 (name)...");
#endif // NDEBUG
...
bool subscriberCallback(simInt scriptId, const char *func, subscriberCallback_in *in_args, subscriberCallback_out *out_args)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback function for \"subscriberCallback\"...");
...
bool imageTransportCallback(simInt scriptId, const char *func, imageTransportCallback_in *in_args, imageTransportCallback_out *out_args)
{
    ...
    if(isDebugStubsEnabled())
    {
        log(sim_verbosity_debug, "DEBUG_STUBS: script callback function for \"imageTransportCallback\"...");
        log(sim_verbosity_debug, "DEBUG_STUBS: writing input arguments...");
    }
#endif // NDEBUG
